"""
Class used to demonstrate exceptions and using files. Built in last 3 labs
used to create files which contain employee data built by using an employee class
"""
...
class Employee:
    ...
    def get_all(cls, file_name=None):
        ...
        try:
            ...
            raise MissingEmployeeError(f"no employeeat line {line_number}")
